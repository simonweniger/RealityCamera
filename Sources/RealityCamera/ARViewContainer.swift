...
///
/// Create an ``RealityCamera`` externally and hand it into the container so that you can interact with the
...
public struct ARViewContainer: PlatformViewRepresentable {
    ...
    public var cameraARView: RealityCamera
    ...
    public init(cameraARView: RealityCamera) {
